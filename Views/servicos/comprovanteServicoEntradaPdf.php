...
$result=mysqli_query($conexao,$sql);
 ...
 ?>	
 	...
 	<title>ENTRADA DE EQUIPAMENTO</title>
...
<div class="text-center">
 		<p><strong>ENTRADA DE EQUIPAMENTO</strong></p>
</div>
...
<div id="Coluna2" class="text-center">
 		...
 		<table class="table table-bordered" style="border-collapse: collapse; margin-top:100px;" border="1" width="135px">
 		 ...
 		 <table class="table table-bordered" style="border-collapse: collapse; margin-top:30px;" border="1" width="135px">
